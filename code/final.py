...
pygame.init()
size = [1280,720]
sc = pygame.display.set_mode(size,RESIZABLE)
...
while not done:
    ...
    while newgame!=0:
        ...
        if checkmenu%2 == 1:
            ...
            sgold1 = pygame.font.SysFont("Arial",40)
            ...
            statusnum = pygame.font.SysFont("Arial",40)
            ...
            if itemmenu%2 == 1:
                store1 = pygame.font.SysFont("Arial",50)
            ...
            if abilitymenu%2 == 1:
                ...
                cleft2 = cleft1.render('A',1,numm)
                sc.blit(cleft2,(605,305))
                cremain1 = pygame.font.SysFont("Arial",40)
        ...
        if needbattle%2 == 1:
            if battlelen < 1280:
                ...
                monsta = pygame.font.SysFont("Arial",40)
                ...
                if battleitemmenu%2 == 0:
                    ...
                    bim = pygame.font.SysFont("Arial",100)
                ...
                monstatus1 = pygame.font.SysFont("Arial",50)
                ...
                smiss1 = pygame.font.SysFont("Arial",40)
        ...
        if mycharacter.hpnd == 0:
            if len(moslist) != 0:
                ...
                if faillen6 != 200:
                    failword = pygame.font.SysFont("Arial",250)
                    if faillen1 != 200:
                        faillen1 += 20
